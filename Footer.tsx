        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a href="https://www.linkedin.com/in/eric-brunnel-quenum-8b99703a4" target="_blank" rel="noopener noreferrer" className="h-8 w-8 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-all" data-testid="link-footer-linkedin" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li data-testid="text-footer-email">
                <a href="mailto:infosecureflowco@gmail.com" className="flex items-center gap-2 hover:text-white transition-colors break-all">
                  <Mail className="w-4 h-4 text-primary shrink-0" />
                  <span>infosecureflowco@gmail.com</span>
                </a>
              </li>
              <li data-testid="text-footer-phone">
                <a href="tel:+22950636363" className="flex items-center gap-2 hover:text-white transition-colors">
                  <Phone className="w-4 h-4 text-primary shrink-0" />
                  <span>+229 50 63 63 63</span>
                </a>
              </li>
            </ul>
          </div>
