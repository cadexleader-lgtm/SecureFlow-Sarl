      ...
      <section className="relative min-h-[620px] h-[78vh] max-h-[820px] flex items-center pt-16 overflow-hidden bg-black">
        <AnimatePresence initial={false}>
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-black/55 md:bg-transparent md:bg-gradient-to-r md:from-black/90 md:via-black/70 md:to-black/10"></div>
        ...
        <div className="container px-5 md:px-8 mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            <p className="text-base md:text-lg text-white/80 mb-8 md:mb-10 leading-relaxed max-w-2xl mx-auto md:mx-0">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center md:justify-start gap-3 md:gap-4">
              ...
              <Button size="lg" variant="outline" className="h-12 md:h-14 px-6 md:px-8 text-sm md:text-base rounded-full border-white/40 bg-transparent text-white hover:bg-white/10 w-full sm:w-auto" asChild>
          ...
          {heroSlides.map((_, i) => (
            ...
            >
              <span className={`block h-1 rounded-full transition-all ${
                currentSlide === i ? "w-8 bg-primary" : "w-4 bg-white/40 group-hover:bg-white/70"
              }`} />
            </button>
          ))}
        </div>
        ...
        <div className="container px-4 mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button size="lg" variant="outline" className="rounded-full px-8 md:px-10 h-12 md:h-14 text-base md:text-lg border-border hover:bg-secondary w-full sm:w-auto" asChild>
                ...
                <div className="relative rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl bg-card">
                  ...
                  <div className="absolute bottom-8 left-8 right-8 p-6 glass-card border-white/10 rounded-2xl transform translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-500">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-foreground font-bold">{t("home.mission.activeSecure")}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-5 md:gap-6">
            {mainServices.map((service, idx) => (
              <motion.div
                ...
                className={`group relative ${idx < 3 ? "lg:col-span-2" : "lg:col-span-3"} ${idx === mainServices.length - 1 ? "md:col-span-2 lg:col-span-3" : ""}`}
              >
                ...
                <Link href="/services" className="relative glass-card p-7 md:p-8 rounded-2xl group-hover:border-primary/40 transition-colors duration-300 h-full flex flex-col">
              ...
              <div className="relative group">
                ...
                <div className="relative glass-card p-10 md:p-16 rounded-[3rem] border-white/10 shadow-2xl overflow-hidden group-hover:border-primary/30 transition-all duration-500">
                  ...
                  <div className="relative space-y-10">
                    <p className="text-xl md:text-2xl text-foreground font-display leading-snug tracking-tight">
          ...
          <div className="secureflow-carousel-track flex gap-4">
            {[...carouselImages, ...carouselImages].map((img, i) => (
              <div key={i} className="shrink-0 w-48 h-32 md:w-64 md:h-44 rounded-xl overflow-hidden border border-white/5 hover:border-primary/30 transition-all group">
                <img 
                  src={img} 
                  alt={i < carouselImages.length ? `Opération SecureFlow ${i + 1}` : ""}
        ...
        <div className="container px-4 mx-auto max-w-5xl relative z-10">
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl md:text-3xl font-display font-medium text-foreground leading-snug max-w-3xl mx-auto">
