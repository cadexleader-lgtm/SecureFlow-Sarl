  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-4 left-4 md:bottom-6 md:left-6 z-50 h-12 w-12 md:h-14 md:w-14 rounded-full bg-primary text-primary-foreground shadow-2xl shadow-primary/30 flex items-center justify-center hover:scale-110 transition-transform"
      ...
      {isOpen && (
        <div className="fixed bottom-20 left-4 md:bottom-24 md:left-6 z-50 w-[calc(100vw-2rem)] max-w-80 glass-card p-6 rounded-2xl border border-white/10 shadow-2xl animate-in slide-in-from-bottom-5">
